    ...
    return {
        ...
        common: {
            ...
            boolean(val, trueText = '是', falseText = '否') {
                ...
                return isTrue
                    ? `<span class="badge badge-success-subtle"><i class="fa-solid fa-circle-check me-1"></i>${trueText}</span>`
                    : `<span class="badge badge-danger-subtle"><i class="fa-solid fa-ban me-1"></i>${falseText}</span>`;
            },
            ...
            country(countryCode) {
                ...
                switch (code) {
                    case 'TW': return `<span class="badge badge-cyan-subtle font-monospace me-1">TW</span>`;
                    case 'MY': return `<span class="badge badge-yellow-subtle font-monospace me-1">MY</span>`;
                    default: return `<span class="badge badge-gray-subtle font-monospace me-1">未設定</span>`;
                }
            }
        },

        // ====================================================================
        // 2. 產品與商品領域 (UIBadges.product.*)
        // ====================================================================
        product: {
            /**
             * 產品體系分類標籤 (主系列 / 次系列 / 型態)
            ...
            launchStatus(statusCode) {
                switch (statusCode) {
                    case 'ACTIVE': return '<span class="badge badge-success"><i class="fa-solid fa-circle-check me-1"></i>販售中</span>';
                    case 'COMING_SOON': return '<span class="badge badge-warning"><i class="fa-solid fa-clock me-1"></i>即將上市</span>';
                    case 'DISCONTINUED': return '<span class="badge badge-danger"><i class="fa-solid fa-ban me-1"></i>已下市</span>';
                    default: return '<span class="badge badge-gray"><i class="fa-solid fa-question me-1"></i>未設定</span>';
                }
            },
            ...
            stockStatus(stockCode) {
                switch (stockCode) {
                    case '現貨': return '<span class="badge badge-success-subtle"><i class="fa-solid fa-box me-1"></i>現貨</span>';
                    case '缺貨': return '<span class="badge badge-danger-subtle"><i class="fa-solid fa-circle-xmark me-1"></i>缺貨</span>';
                    case '預購': return '<span class="badge badge-accent-subtle"><i class="fa-solid fa-clock me-1"></i>預購</span>';
        ...
        psi: {
            ...
            warehouseType(warehouseType) {
                ...
                switch (type) {
                    case '官方營運中心': return '<span class="badge badge-outline-blue"><i class="fa-solid fa-building-flag me-1"></i>官方營運中心</span>';
                    case '自用常備倉': return '<span class="badge badge-outline-teal"><i class="fa-solid fa-vault me-1"></i>自用常備倉</span>';
                    case '海外商務倉': return '<span class="badge badge-outline-cyan"><i class="fa-solid fa-plane-departure me-1"></i>海外商務倉</span>';
                    case '物流在途倉': return '<span class="badge badge-outline-white"><i class="fa-solid fa-truck-fast me-1"></i>物流在途倉</span>';
                    default: return '<span class="badge badge-outline-gray"><i class="fa-solid fa-question me-1"></i>未設定</span>';
                }
            },
             ...
             */
            alertType(alertType) {
                const type = clean(alertType);
                switch (type) {
                    case '低於安全水位': return '<span class="badge badge-orange-subtle"><i class="fa-solid fa-circle-exclamation me-1"></i>低於安全水位</span>';
                    case '90天近效期': return '<span class="badge badge-warning-subtle"><i class="fa-solid fa-hourglass-half me-1"></i>90天近效期</span>';
                    case '30天極危效期': return '<span class="badge badge-danger-subtle"><i class="fa-solid fa-triangle-exclamation me-1"></i>30天極危效期</span>';
                    case '已過期': return '<span class="badge badge-danger"><i class="fa-solid fa-skull me-1"></i>已過期</span>';
                    case '品質鎖定': return '<span class="badge badge-muted-subtle"><i class="fa-solid fa-lock me-1"></i>品質鎖定</span>';
                    case '日常提示': return '<span class="badge badge-info-subtle"><i class="fa-solid fa-circle-info me-1"></i>品質鎖定</span>';
                    default: return `<span class="badge badge-gray-subtle"><i class="fa-solid fa-question me-1"></i>未設定</span>`;
                }
            },
            ...
            alertLevel(alertLevel) {
                const lvl = clean(alertLevel);
                switch (lvl) {
                    case '緊急': return '<span class="badge badge-danger fw-bold"><i class="fa-solid fa-triangle-exclamation me-1"></i>緊急</span>';
                    case '注意': return '<span class="badge badge-warning fw-bold"><i class="fa-solid fa-circle-exclamation me-1"></i>注意</span>';
                    case '一般': return '<span class="badge badge-info">一般</span>';
                    default: return `<span class="badge badge-gray"><i class="fa-solid fa-question me-1"></i>未設定</span>`;
                }
            },
            ...
            alertStatus(statusCode) {
                const s = clean(statusCode);
                switch (s) {
                    case '已知悉': return '<span class="badge badge-info-subtle">已知悉</span>';
                    case '已轉促銷/試用': return '<span class="badge badge-warning-subtle">已轉促銷/試用</span>';
                    case '已結案出清': return '<span class="badge badge-success-subtle">已結案出清</span>';
                    case '未處理': return '<span class="badge badge-muted-subtle">未處理</span>';
            ...
            adjustType(type) {
                const t = clean(type);
                switch (t) {
                    case '盤盈': return '<span class="badge badge-success"><i class="fa-solid fa-plus me-1"></i>盤盈</span>';
                    case '盤虧': return '<span class="badge badge-danger"><i class="fa-solid fa-minus me-1"></i>盤虧</span>';
                    case '破損過期': return '<span class="badge badge-danger"><i class="fa-solid fa-triangle-exclamation me-1"></i>破損過期</span>';
                    case '自用消耗': return '<span class="badge badge-purple"><i class="fa-solid fa-box-archive me-1"></i>自用消耗</span>';
                    case '試用發放': return '<span class="badge badge-warning"><i class="fa-solid fa-hand-holding-heart me-1"></i>試用發放</span>';
                    case '拆盒解封': return '<span class="badge badge-purple"><i class="fa-solid fa-box-open me-1"></i>拆盒解封</span>';
                    case '跨倉調撥': return `<span class="badge badge-info"><i class="fa-solid fa-right-left me-1"></i>跨倉調撥</span>`;
                    default: return `<span class="badge badge-gray"><i class="fa-solid fa-question me-1"></i>未設定</span>`;
                }
            },
            ...
            inboundStatus(status) {
                ...
                switch (s) {
                    case '草稿': return '<span class="badge badge-muted-subtle"><i class="fa-solid fa-pen-ruler me-1"></i>草稿</span>';
                    case '待自取': return '<span class="badge badge-purple-subtle"><i class="fa-solid fa-clock me-1"></i>待自取</span>';
                    case '運輸中': return '<span class="badge badge-info-subtle"><i class="fa-solid fa-truck-fast me-1"></i>運輸中</span>';
                    case '已入庫': return '<span class="badge badge-success-subtle"><i class="fa-solid fa-circle-check me-1"></i>已入庫</span>';
            ...
            stockLock(isLocked) {
                ...
                return locked
                    ? '<span class="badge badge-outline-danger-subtle"><i class="fa-solid fa-lock me-1"></i>凍結禁出</span>'
                    : '<span class="badge badge-outline-success-subtle"><i class="fa-solid fa-circle-check me-1"></i>自由流通</span>';
            },
            ...
            preOrderHold(isHold, isDetailed = false) {
                ...
                if (isDetailed) {
                    return isY
                        ? '<span class="badge badge-warning"><i class="fa-solid fa-lock me-1"></i>預扣鎖定中</span>'
                        : '<span class="badge badge-success"><i class="fa-solid fa-lock-open me-1"></i>正常交付出清</span>';
                }
                return isY
                    ? '<span class="badge badge-warning"><i class="fa-solid fa-lock me-1"></i>預扣</span>'
                    : '<span class="badge badge-success"><i class="fa-solid fa-lock-open me-1"></i>正常</span>';
            },
            ...
            feeItem(isFee) {
                ...
                return fee
                    ? `<span class="badge badge-outline-muted-subtle">作業費用</span>`
                    : `<span class="badge badge-outline-purple-subtle">實體商品</span>`;
            }
        },

        // ====================================================================
        // 4. 組織與夥伴領域 (UIBadges.partner.*)
        // ====================================================================
        partner: {
            /**
            ...
            relation(relation, partnerId = '') {
                if (partnerId === 'PTN-001' || partnerId === 'PTN-0001' || partnerId === 'PTN-002' || partnerId === 'PTN-0002' || relation === '核心成員') {
