...
window.addEventListener('AppReady', function () {
    ...
    $('.calc-step').click(function () {
        ...
        if (step === 1) {
            ...
            $('#calc-time').html('<i class="fa-regular fa-clock me-1"></i>預估所需時間：3 ~ 6 個月');
            ...
            $('#calc-time').html('<i class="fa-regular fa-clock me-1"></i>預估所需時間：6 個月 ~ 1 年');
            ...
            $('#calc-time').html('<i class="fa-regular fa-clock me-1"></i>預估所需時間：1.5 年 ~ 3 年');
